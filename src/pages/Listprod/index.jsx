...
class ListProd extends Component {
    ...
    componentDidMount(){
        ...
        .then((res)=>{
            ...
            let filter = res.data.filter(val => val.end_date >= new Date().getTime())
                ...
                <div key={val.id} className="col-md-3 px-2 py-2">
                    <Link to={'/products/'+val.id}>
                        <Card className='kartu card-rounded'>
                            <CardImg top width="100%" className='card-rounded' height={200} src={API_URL_BE + val.banner} alt="Card image cap" />
